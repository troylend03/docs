...
**Brokerage via Secure Connection:** [REVIEW REQUIRED: Confirm data fields]
...
| **Brokerage aggregator** | Brokerage | Auth tokens only |
...
1. You enter credentials directly with our secure connection service (not us)
2. The service verifies identity with your brokerage
3. It provides us a secure token
